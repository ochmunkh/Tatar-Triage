...
TATAR нь нэг файлаас бүрдэх, хамаарал багатай **triage цуглуулагч** — Windows
(`Tatar.ps1`, 30 модуль) ба Linux (`tatar-linux.sh`, 18 модуль) хувилбар нэг л
нэгдсэн схем (`schemaVersion 1.2`) гаргана.

Ажиллагааны гол урсгал: аргумент задлах → гаралтын хавтас + chain of custody →
орчны илрүүлэлт → **volatility дараалалаар** модулиуд ажиллаж, түүхий нотолгоо
(диск рүү) ба бүтэцлэгдсэн finding (санах ойд) зэрэг үүсгэнэ → **allowlist**
хөдөлгүүр мэдэгдэж буй сайн зүйлсийг дарна → **IOC** хөдөлгүүр мэдэгдэж буй мууг
тэмдэглэж, allowlist-ийг давж, шинэ finding босгоно → эцэст нь active/suppressed
гэж эрэмбэлж `summary.txt/json`, `findings.json`, SHA-256 manifest бичнэ.

Гол зарчим: **зөвхөн уншина, нуумаггүй, finding бол дүгнэлт биш харин шалгах
сэжүүр**, өгөгдөл гадагш явуулахгүй (offline). Allowlist нь зам/нийтлэгч/пакет
эзэмшил/хэшээр итгэлийг тогтооно; IOC таарвал High/0.95 болж allowlist-ийг давна.
Exit code: `0` амжилттай, `1` алдаа/буруу хэрэглээ, `2` алдаатай дуссан.
